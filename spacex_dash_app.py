...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig2 = px.pie(class_counts, values='count',
        names='class',
...
def get_scatter_chart(entered_site, selected_payload):
    ...
    if entered_site == 'ALL':
        fig3 = px.scatter(data_frame=filtered_df, x='Payload Mass (kg)', y='class',
        color='Booster Version Category',
        title='Correlation between Payload and Succes for all Sites')
        return fig3
    else:
        filtered_df = filtered_df.loc[filtered_df['Launch Site'] == entered_site]
        fig4 = px.scatter(data_frame=filtered_df, x='Payload Mass (kg)', y='class',
        color='Booster Version Category',
